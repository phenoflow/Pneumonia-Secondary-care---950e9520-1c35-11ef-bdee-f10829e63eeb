...
codes = [{"code":"CA40.04","system":"icd11"},{"code":"J15.7","system":"icd11"},{"code":"483.0","system":"icd11"},{"code":"CA40.04","system":"icd11"},{"code":"J15.7","system":"icd11"},{"code":"483.0","system":"icd11"}];
REQUIRED_CODES = 1;
